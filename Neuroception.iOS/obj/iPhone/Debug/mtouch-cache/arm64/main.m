...
extern void *mono_aot_module_Neuroception_iOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_Neuroception_info;
...
extern void *mono_aot_module_AWSSDK_Core_info;
extern void *mono_aot_module_PCLCrypto_info;
extern void *mono_aot_module_Validation_info;
extern void *mono_aot_module_PCLStorage_Abstractions_info;
extern void *mono_aot_module_PCLStorage_info;
extern void *mono_aot_module_AWSSDK_CognitoIdentity_info;
extern void *mono_aot_module_AWSSDK_SecurityToken_info;
extern void *mono_aot_module_AWSSDK_DynamoDBv2_info;
...
extern void *mono_aot_module_AWSSDK_SimpleEmail_info;
...
{
	mono_aot_register_module (mono_aot_module_Neuroception_iOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_Neuroception_info);
	...
	mono_aot_register_module (mono_aot_module_AWSSDK_Core_info);
	mono_aot_register_module (mono_aot_module_PCLCrypto_info);
	mono_aot_register_module (mono_aot_module_Validation_info);
	mono_aot_register_module (mono_aot_module_PCLStorage_Abstractions_info);
	mono_aot_register_module (mono_aot_module_PCLStorage_info);
	mono_aot_register_module (mono_aot_module_AWSSDK_CognitoIdentity_info);
	mono_aot_register_module (mono_aot_module_AWSSDK_SecurityToken_info);
	mono_aot_register_module (mono_aot_module_AWSSDK_DynamoDBv2_info);
	...
	mono_aot_register_module (mono_aot_module_AWSSDK_SimpleEmail_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Neuroception.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
