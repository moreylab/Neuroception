...
@class Neuroception_iOS_GradientColorStackRenderer;
@class Neuroception_iOS_Interfaces_BluetoothManager;
@class Neuroception_iOS_Interfaces_UserNotificationCenterDelegate;
...
@class Plugin_BluetoothLE_AdapterContext;
...
@interface Neuroception_iOS_GradientColorStackRenderer : Xamarin_Forms_Platform_iOS_VisualElementRenderer_1 {
}
	-(void) drawRect:(CGRect)p0;
	-(id) init;
@end

@interface Neuroception_iOS_Interfaces_BluetoothManager : NSObject<CBCentralManagerDelegate> {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface Neuroception_iOS_Interfaces_UserNotificationCenterDelegate : NSObject<UNUserNotificationCenterDelegate> {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface Plugin_BluetoothLE_AdapterContext : NSObject<CBCentralManagerDelegate> {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
