package md56e93a61007e9534b9b6779ca67ff3b68;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.BluetoothLE.Internals.GattCallbacks, Plugin.BluetoothLE", GattCallbacks.class, __md_methods);
	}
	...
	public GattCallbacks ()
	{
		...
		if (getClass () == GattCallbacks.class)
			mono.android.TypeManager.Activate ("Plugin.BluetoothLE.Internals.GattCallbacks, Plugin.BluetoothLE", "", this, new java.lang.Object[] {  });
	}
